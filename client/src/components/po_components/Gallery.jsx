...
const Gallery = ({ selectedStyle, selectedImageIndex, changeSelectedImgInx }) => {
  ...
  return (
    <div id="imageGallery">
      ...
      <div className="dcarousel__viewport">
        {selectedStyle.photos.map((photo, index) => {
...
{/*               <img className="displayedImage" alt="x" src={photo.url} /> */}
              <div className="carousel__snapper">
                <a href={prevHref} className="carousel__prev">Go to last slide</a>
                <a href={nextHref} className="carousel__next">Go to next slide</a>
              </div>
            </li>
          );
        })}
